...
# Conclución aplicacion metodología Holt-Winters

La nueva serie de datos aplicando el método de suavizamiento exponencial permitio disminuir los picos  que se observaban en el  modelo original permitiendo disminuir el ruido y mostrando un modelo predictivo que apunta al ausentismo laboral en el comienzo y final de la semana.
